...
<body>
  ...
  <!-- start historique ENG -->
  <section class="container mt-5">
        <h2 class="text-center mb-4">Historique de l'Entreprise Nationale des Granulats (ENG)</h2>

        <p>
            L'Entreprise Nationale des Granulats (ENG) est une société par actions. Le capital social de la société est de 3 milliards de dinars.
        </p>

        <p>
            Les actions de l'ENG étaient réparties entre le fonds de participation construction, mines et chimie pharmacie, à partir du 05 mai 1990, puis dans le portefeuille du Holding Public Mines à partir de 1996, et enfin dans le portefeuille de la société de gestion des participations (SGP) SOMINES d’octobre 2001 à décembre 2011. Actuellement, l’ENG fait partie du groupe industriel minier MANADJIMELDJAZAIR « MANAL ».
        </p>

        <p>
            Le capital social de la société est passé de 112 millions de dinars en 1990 à 3 milliards de dinars en 2007. Le siège de l'entreprise est implanté au Gué de Constantine - Alger.
        </p>
        ...
        <p>
            A compter de l'année 2000, la relance de l'activité économique est ressentie, ce qui a permis à l'ENG de renforcer davantage son activité en confortant sa présence sur le marché national et en réalisant des performances en matière de production et de résultats financiers.
        </p>

        <p>
            Le patrimoine de l'ENG est constitué de neuf (09) carrières de granulats, une usine de carbonate de calcium, et une unité chargée des pierres ornementales appelée RoCaAl.
        </p>

        <p>
            Les trois (3) plans de développement gouvernemental successifs (2000-2004), (2005-2009) et (2010-2014) ont induit une forte demande de granulats avec cependant une pause en (2011/2012). Cette forte demande a encouragé l’ENG à engager d’importants investissements :
        </p>

        <ul>
            <li>Renouvellement de ses moyens de production.</li>
            <li>Augmentation de ses capacités telles que l’extension de l’unité SI MUSTAPHA (W.Boumerdes) + 1 million de tonnes/an en 2007.</li>
            <li>Nouvelle unité d'EL MALEH (W.AinTemouchent) + 1 million de tonnes/an en 2007, en remplacement de celle de CHAABAT EL HAM fermée en 2014 suite à l'épuisement des réserves.</li>
            <li>Extension de l’unité ELMA LABIOD (W.Tébessa) + 500 000 tonnes/an en 2008.</li>
            <li>Installation de sable de concassage D’EL HACHIMIA (W.Bouira) + 500 000 tonnes/an en 2008.</li>
            <li>Extension de l’unité SIDI ABDELLI (W.Tlemcen) + 200 000 tonnes/an de sable de concassage.</li>
        </ul>

        <p>
            L’ENG produit du sable de concassage destiné au béton hydraulique et aux travaux publics de très haute qualité, conforme aux Normes Algériennes et Européennes. Toutes les unités proposent des sables de concassage en substitution aux sables d’oued dont l’extraction est interdite.
        </p>
    </section>
    <!-- end historique ENG -->
